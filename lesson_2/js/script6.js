...
document.write(`
<div class="result">
	<p >Snikers ${snikersPrice} x ${snikersNumber} = ${snikersTotalPrice}UAH</p>
	<p >Bread ${breadPrice} x ${breadNumber} = ${breadTotalPrice}UAH</p>
	<p >Chips ${chipsPrice} x ${chipsNumber} = ${chipsTotalPrice}UAH</p>
